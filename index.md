...
<div class="profile-header">
  <div class="profile-text">
    ...
    <ol class="bio research-threads">
      ...
      <li><strong>Unified multimodal training and representation learning.</strong> I am interested in how visual understanding — video, grounding, and spatial reasoning — fits into modern multimodal pretraining (see <a href="#pub-molmo2">Molmo2</a>, <a href="#pub-ipt">IPT</a>).</li>
    </ol>
...
- <img class="affiliation-icon" src="img/icons/uw.svg" alt="UW"> **University of Washington** — B.S. (with Honors, cum laude) in Computer Science, 2023–2026
