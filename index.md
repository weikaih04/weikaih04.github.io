...
<div class="profile-header">
  <div class="profile-text">
    ...
    <p class="bio">My research focuses on <strong>developing generalized visual and spatial representations and models</strong> for robotics and embodied agents:</p>
